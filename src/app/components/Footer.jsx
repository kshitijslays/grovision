...
export default function FooterGlow() {
  ...
  .glass {
    ...
    background: radial-gradient(circle, #0000001a 0%, #00dcf41a 60%, #001a1a 100%);
    border: 1px solid #00dcf41a;
  ...
  .glass:where(.dark, .dark *) {
    ...
    background: radial-gradient(circle, #0000001a 0%, #001e1e1a 60%, #0e2a2a 100%) !important;
    border: 1px solid #00dcf41a !important;
...
`}</style>
      ...
      <div className="pointer-events-none absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 select-none">
        <div className="absolute -top-32 left-1/4 h-72 w-72 rounded-full bg-[#00DCF4]/20 blur-3xl"></div>
        <div className="absolute right-1/4 -bottom-24 h-80 w-80 rounded-full bg-[#00DCF4]/20 blur-3xl"></div>
      </div>
        ...
        <div className="glass relative mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
          <div className="flex flex-col items-center md:items-start">
            <a href="#" className="mb-4 flex items-center gap-2">
              <span className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-[#00DCF4] to-[#008EA4] text-2xl font-extrabold text-white shadow-md">
                <svg
            ...
            <div className="mt-2 flex gap-3 text-[#00DCF4]">
              <a
                href="#"
                aria-label="Twitter"
          ...
          <nav className="flex w-full flex-col gap-9 text-center md:w-auto md:flex-row md:justify-end md:text-left">
            <div>
              <div className="mb-3 text-xs font-semibold tracking-widest text-[#00DCF4] uppercase">
                Product
              </div>
